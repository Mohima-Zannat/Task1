...
function validate(){
	...
	if(month.value !="0")
	{
		if(date.value !="0")
		{
			if(year.value !="0")
			{
				...
				err_dob.style.fontWeight = "850";
			}
			else
			{
				err_dob.innerHTML = " *Date, month, year required";
				err_dob.style.color="blue";
				err_dob.style.fontWeight = "850";
				allSet=false;
			}
		}
	...
	if(Number.isInteger(cr))
	{
		...
		err_credit.style.fontWeight = "850";
	}
	else
	{
		err_credit.innerHTML = " *Credit required only numeric";
		err_credit.style.color="blue";
		err_credit.style.fontWeight = "850";
		allSet=false;
	}
	...
	if(department.value !="0")
	{
		...
		err_department.style.fontWeight = "850";
	}
	else
	{
		err_department.innerHTML = " * Department required";
		err_department.style.color="blue";
		err_department.style.fontWeight = "850";
		allSet=false;
	}
