		...
		<form action="" method="post">
				<table>
					<tr>
						...
						<td><span style="color:blue;">*<?php echo $err_book_name;?></span>
						</td>
					</tr>
					<tr>
						<td>catagory:</td>
					...
					<tr>
						...
						<td><span style="color:blue;">*<?php echo $err_description;?></span>
						</td>
					</tr>
					<tr>
						<td>publisher:</td>
						<td><input type="text" value="<?php echo $publisher?>" name="publisher"></td>
						<td><span style="color:blue;">*<?php echo $err_publisher;?></span>
						</td>
					</tr>
					<tr>
						<td>eddition:</td>
						<td><input type="text" value="<?php echo $eddition; ?>" name="eddition"></td>
						<td><span style="color:blue;">*<?php echo $err_eddition;?></span>
						</td>
					</tr>
					<tr>
						<td>isbn:</td>
						<td><input type="text" value="<?php echo $isbn ?>" name="isbn"></td>
						<td><span style="color:blue;">*<?php echo $err_isbn;?></span>
						</td>
					</tr>
					<tr>
						<td>pages:</td>
						<td><input type="text" value="<?php echo $pages ?>" name="pages"></td>
						<td><span style="color:blue;">*<?php echo $err_pages;?></span>
						</td>
					</tr>
					<tr>
						<td>price:</td>
						<td><input type="text" value="<?php echo $price ?>" name="price"></td>
						<td><span style="color:blue;">*<?php echo $err_price;?></span>
						</td>
					</tr>
					<tr>
